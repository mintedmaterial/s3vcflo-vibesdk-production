/* interface Env {
	...
	ALLOWED_EMAIL: "Mintedmaterial@gmail.com, serviceflowagi@gmail.com";
	DISPATCH_NAMESPACE: "s3vcflo-vibesdk-default-namespace";
	ANTHROPIC_API_KEY: string;-disable */
...
declare namespace Cloudflare {
	interface Env {
		...
		CONTAINER_PREVIEW_SUBDOMAIN: string;
